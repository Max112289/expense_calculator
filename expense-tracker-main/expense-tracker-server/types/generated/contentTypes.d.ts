...
export interface ApiFinanceHistoryFinanceHistory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    finance: Schema.Attribute.Relation<'manyToOne', 'api::finance.finance'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::finance-history.finance-history'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFinanceFinance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    finance_histories: Schema.Attribute.Relation<
      'oneToMany',
      'api::finance-history.finance-history'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiJoinAccountEntryJoinAccountEntry
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    join_account: Schema.Attribute.Relation<
      'manyToOne',
      'api::join-account.join-account'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::join-account-entry.join-account-entry'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiJoinAccountJoinAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    join_account_entries: Schema.Attribute.Relation<
      'oneToMany',
      'api::join-account-entry.join-account-entry'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    firstName: Schema.Attribute.String;
    join_accounts: Schema.Attribute.Relation<
      'manyToMany',
      'api::join-account.join-account'
    >;
    lastName: Schema.Attribute.String;
    ...
    payment_details: Schema.Attribute.Relation<
      'oneToMany',
      'api::payment-detail.payment-detail'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::finance-history.finance-history': ApiFinanceHistoryFinanceHistory;
      'api::finance.finance': ApiFinanceFinance;
      'api::join-account-entry.join-account-entry': ApiJoinAccountEntryJoinAccountEntry;
      'api::join-account.join-account': ApiJoinAccountJoinAccount;
